...
A token is a way for the server to verify a user is allowed acces to protected data and to use the site without logging in

- [ ] What steps can you take in your web apps to keep your data secure?

login page, and token required

- [ ] Describe how web servers work.

the browser requests a url and the webserver will respond to the request and provide the data
